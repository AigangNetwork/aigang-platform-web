<template>
  <el-dialog :title="$t('insurance.policy.termsAndConditions.title')" :visible.sync="show">
    <div class="terms-and-conditions-container">
      ...
      <div class="buttons">
        <el-button class="button" type="primary" @click="disagree">{{ $t('insurance.policy.termsAndConditions.buttons.disagree') }}</el-button>
        <el-button class="button" type="primary" :disabled="agreeButtonDisabled" @click="agree">{{ $t('insurance.policy.termsAndConditions.buttons.agree') }}</el-button>
      </div>
    </div>
  </el-dialog>
</template>
