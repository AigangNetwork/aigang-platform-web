      ...
      <transition name="slideUp" mode="out-in">
        <el-row class="no-margin" v-if="!isProfileChangeOn">
          ...
          <div class="no-margin name-field">
            <strong>{{ $t('profile.profile.userName')}}: </strong>{{ profileForm.userName }}</div>
          <div class="no-margin name-field">
            <strong>{{ $t('profile.profile.email')}}: </strong>{{ $store.state.user.profile.email }}</div>
            ...
            <el-row>
              <div class="col-3">
                <el-form-item prop="firstName">
                  <el-input class="profile-info-input" type="text" v-model="profileForm.firstName" :placeholder="$t('profile.profile.firstName' )"></el-input>
                </el-form-item>
              </div>
              <div class="col-3">
                <el-form-item prop="lastName">
                  <el-input class="profile-info-input" type="text" v-model="profileForm.lastName" :placeholder="$t('profile.profile.lastName' )"></el-input>
                </el-form-item>
              </div>
            </el-row>
            <el-row>
              <div class="nickname-container">
                <el-form-item prop="userName">
                  <el-input class="profile-info-input" type="text" v-model="profileForm.userName" :placeholder="$t('profile.profile.userName' )"></el-input>
                </el-form-item>
              </div>
            </el-row>
            <el-row>
