<template>
  <div class="aig-container aig-view">
    <Card class="guest-card portfolio-card">
      <div slot="body">
        <router-link :to="{ name: 'Data'}" class="back-button">
          <i class="back-icon el-icon-arrow-left"></i>
        </router-link>
        <h1>
          Cookie Policy for Aigang Platform
        </h1>

        <p>This is the Cookie Policy for Aigang Platform, accessible from https://testplatform.aigang.network/data</p>
        ...
        <p>You can prevent the setting of cookies by adjusting the settings on your browser (see your browser Help for
          how to
          do this). Be aware that disabling cookies will affect the functionality of this and many other websites that
          you
